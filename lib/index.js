...
var _mentionComponents__test__CustomList = require('mention/components/__test__/CustomList');

var _mentionComponents__test__CustomList2 = _interopRequireDefault(_mentionComponents__test__CustomList);
...
_react2['default'].render(_react2['default'].createElement(
  ...
  _react2['default'].createElement(_mentionMention2['default'], {
    ...
    customRenderer: function (_ref) {
      ...
      return _react2['default'].createElement(_mentionComponents__test__CustomList2['default'], {

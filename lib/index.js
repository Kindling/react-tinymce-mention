...
var _mentionComponents__tests__CustomList = require('./mention/components/__tests__/CustomList');

var _mentionComponents__tests__CustomList2 = _interopRequireDefault(_mentionComponents__tests__CustomList);
...
_react2['default'].render(_react2['default'].createElement(
  ...
  _react2['default'].createElement(_mentionMention2['default'], {
    ...
    customRenderer: function (_ref) {
      ...
      return _react2['default'].createElement(_mentionComponents__tests__CustomList2['default'], {

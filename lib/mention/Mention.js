...
var Mention = (function () {
  ...
  _createClass(Mention, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _plugin.initializePlugin)(store, dataSource, delimiter, onRemove).then(this._transformAndDispatch.bind(this))['catch'](function (error) {
        console.error(error);
      });
    }
  }, {
    ...
    value: {
      ...
      customListRenderer: _react2['default'].PropTypes.func,
      customRTEMention: _react2['default'].PropTypes.func,

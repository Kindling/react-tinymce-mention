...
var Mention = (function () {
  ...
  _createClass(Mention, [{
    ...
    value: function componentWillMount() {
      ...
      this.store = (0, _utilsInitializeRedux2['default'])({
    ...
    value: function componentDidMount() {
      ...
      (0, _plugin.initializePlugin)(this.store, dataSource, delimiter, onRemove).then(this._transformAndDispatch.bind(this))['catch'](function (error) {
        console.error(error);
      });
    }
  }, {

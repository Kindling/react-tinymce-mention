...
var _utilsInputIsValid = require('../utils/inputIsValid');

var _utilsInputIsValid2 = _interopRequireDefault(_utilsInputIsValid);
...
function query(input) {
  return function (dispatch, getState) {
    ...
    if (asyncDataSource && (0, _utilsInputIsValid2['default'])(input)) {

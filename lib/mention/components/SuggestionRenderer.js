...
var _mentionComponentsDefaultListJs = require('mention/components/DefaultList.js');

var _mentionComponentsDefaultListJs2 = _interopRequireDefault(_mentionComponentsDefaultListJs);
  ...
  _createClass(SuggestionRenderer, [{
    ...
    value: function _renderCustomComponents() {
      ...
      var onClick = function onClick() {
        return dispatch((0, _mentionActionsMentionActions.select)());
      };
    ...
    value: function render() {
      ...
      return customRenderer ? this._renderCustomComponents() : _react2['default'].createElement(_mentionComponentsDefaultListJs2['default'], null);
    }
  }], [{
    key: 'propTypes',
    value: {

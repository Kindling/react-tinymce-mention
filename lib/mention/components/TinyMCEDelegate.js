...
var TinyMCEDelegate = (function (_Component) {
  ...
  _createClass(TinyMCEDelegate, [{
    ...
    value: function _renderMentionIntoEditor() {
      ...
      var markup = customRTEMention ? customRTEMention(_extends({}, (0, _utilsLast2['default'])(mentions))) : _react2['default'].createElement(_componentsEditorMention2['default'], (0, _utilsLast2['default'])(mentions));

      editor.execCommand('mceInsertRawHTML', false, ' ' + (0, _utilsRenderComponent2['default'])(markup));
      (0, _utilsTinyMCEUtils.exitSelection)(editor);

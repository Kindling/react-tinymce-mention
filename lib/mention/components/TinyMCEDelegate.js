...
var TinyMCEDelegate = (function (_Component) {
  ...
  _createClass(TinyMCEDelegate, [{
    ...
    value: function _renderMentionIntoEditor() {
      ...
      var markup = customRTEMention ? customRTEMention(_extends({}, mention)) : _react2['default'].createElement(_componentsEditorMention2['default'], mention);

      editor.insertContent('insertionplaceholder');

      var bm = editor.selection.getBookmark(2, false);

      editor.setContent(editor.getContent().replace(/@\w+insertionplaceholder/, (0, _utilsRenderComponent2['default'])(markup)));

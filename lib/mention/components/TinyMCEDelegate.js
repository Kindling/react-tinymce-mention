...
var TinyMCEDelegate = (function (_Component) {
  ...
  _createClass(TinyMCEDelegate, [{
    ...
    value: function _renderMentionIntoEditor() {
      ...
      var re = new RegExp(delimiter + '[^' + delimiter + ' ]*?<span id="placeholder"></span>');
      ...
      editor.insertContent('<span id="placeholder"></span>');

      editor.setContent(editor.getContent().replace(re, (0, _utilsRenderComponent2['default'])(markup) + '<span id="cursor">&nbsp;</span>'));

...
function updateMentionText(keyCode) {
  var mentionText = keyCode === keyMap.BACKSPACE ? updateTypedMention('remove') : updateTypedMention('add', (0, _utilsTinyMCEUtils.getLastChar)(editor));

  return mentionText;
}

// FIXME: rewrite hack
function updateTypedMention() {

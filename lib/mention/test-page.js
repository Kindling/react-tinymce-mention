...
_react2['default'].render(_react2['default'].createElement(
  ...
  _react2['default'].createElement(_Mention2['default'], {
    ...
    customRTEMention: function (_ref4) {
      var displayLabel = _ref4.displayLabel;
      var id = _ref4.id;
      var tinymceId = _ref4.tinymceId;

      return _react2['default'].createElement(_componentsEditorMention2['default'], {
